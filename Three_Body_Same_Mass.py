...
ax.scatter(y[2,-1],y[3,-1],color="tab:red",marker="o",s=100,label="m2 ")
ax.scatter(y[4,-1],y[5,-1],color="green",marker="o",s=100,label="m3 ")


'''
ax=fig.add_subplot(1,1,1)
ax.plot(y[0]-xg,y[1]-yg,color="darkblue",label="m1")
ax.plot(y[2]-xg,y[3]-yg,color="tab:red",label="m2")
ax.plot(y[4]-xg,y[5]-yg,color="green",label="m3")
ax.set_title("Motion of m1,m2 and m3 Relative to Centre of Mass\n",fontsize=14)
ax.scatter(y[0,-1]-xg[-1],y[1,-1]-yg[-1],color="darkblue",marker="o",s=100,label="m1")
ax.scatter(y[2,-1]-xg[-1],y[3,-1]-yg[-1],color="tab:red",marker="o",s=100,label="m2")
ax.scatter(y[4,-1]-xg[-1],y[5,-1]-yg[-1],color="green",marker="o",s=100,label="m3")
'''

'''
ax=fig.add_subplot(1,1,1)
ax.plot(y[2]-y[0],y[3]-y[1],color="darkblue",label="m2")
ax.plot(y[4]-y[0],y[5]-y[1],color="green",label="m3")
